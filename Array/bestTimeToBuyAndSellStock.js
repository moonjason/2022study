...
const maxProfit = function(prices) {
    ...
    // looking for the biggest difference 
    let result = 0; 
...
// ^^^^^ MY ULTRA NAIVE METHOD - WON'T WORK ON MASSIVE ARRAYS



// SLIDING WINDOW / TWO POINT METHOD 
// credit: coolsoftwaretyler
